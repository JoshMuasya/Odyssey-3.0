...
const Find = () => {
  ...
  const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_fnjhm1g', 'template_sayk4di', form.current,
      '7sQTTDOHxbobHlDIS')
  ...
  return (
    <div id='contact'
    className='flex flex-col justify-center align-center custom-contact bg-fixed bg-center bg-cover h-fit pt-5
    lg:flex-row'>
        ...
        method="post">
            ...
            <button 
            type="submit"
            className='font-Signika text-yellow border rounded-3xl w-fit px-10 py-5 bg-white hover:bg-yellow hover:text-white hover:border-0'
            >
              Submit
            </button>
        </form>
