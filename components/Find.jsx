...
const Find = () => {
  return (
    <div className='flex flex-row justify-around align-center custom-contact bg-fixed bg-center bg-cover h-screen p-20'>
        <form className='flex flex-col justify-center items-center align-center p-5 gap-y-5'  
